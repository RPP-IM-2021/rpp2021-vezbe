...
public class Rpp2021VezbeApplication {

	public static void main(String[] args) {
		SpringApplication.run(Rpp2021VezbeApplication.class, args);
	}
	 ...
	 */
	/*
	 * U narednoj metodi prikazuju se svi Bean-ovi koji se kreiraju prilikom pokretanja aplikacije,
	 * ne samo oni koje je kreirao korisnik npr. HelloRestController
	 *
	 */
